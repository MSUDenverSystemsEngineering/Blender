...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		#Uninstall Blender 3.5.0 (current version)
		Execute-MSI -Action Uninstall -Path '{B6999FEA-9449-4D4C-BA10-008A03B36D32}' -PassThru -ContinueOnError $true
		#Uninstall Blender 3.1.2
		...
		$exitCode = Execute-MSI -Path "$dirFiles\blender-3.5.0-windows-x64.msi" -Parameters "/qn ALLUSERS=1" -PassThru
		...
		If (Test-Path "$env:Public\Desktop\Blender 3.5.lnk") {
            Remove-Item "$env:Public\Desktop\Blender 3.5.lnk" -Force
        }
	...
	ElseIf ($deploymentType -ieq 'Repair')
	{
		...
		$exitCode = Execute-MSI -Action Repair -Path "$dirFiles\blender-3.5.0-windows-x64.msi" -Parameters "/qn" -PassThru -Allusers
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAZYQVbWDBymLII
# CRmiJO7fwWRin8+S6sZzPngtKA21QqCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgp791cu2a+q3g
# rFxH+lw9GdaTlerpcZ2TFPS/jsoFwKQwDQYJKoZIhvcNAQEBBQAEggGAIVzakkqZ
# z5JHlUbhWZA8ih70Lh/mSuzw6a0yx2bC2lxdlEjFQuPnU4MvpNHRmJHLmKyeXRKM
# Wd+lxdTHEdOGzXHiR6BN9LUo3C7PlyHi7f2f9yhNR4ne/MukRSObc1e3uQXbiiU2
# uSX3VEXEcbeadmmqW+56ZxTE34Wz6kBeYv6XsXqcR40Bb5W/jpH/uih2b6cXToFg
# cQ0DSDd8II3JkwLnQf9O3PPjdEUHV1prk1baczye/4Nwna3DY/VpXxC9LgrwCh/K
# /U7oN8LOLrkH5vOXgsH5/DxZrmbYQNyNzDPnRMHMGk6zAaVAqoEyvBAbHj3JeFid
# 5j2lT+1NV652HMDXhZljwH+hT5iKwS1NIPlMGekQOJI43MDG9rUoidKDCQIgsybq
# DQYr9Cu2Xjs5lu+3lHtBA+u1JQK7irGZ1aVOrBIp4qcQG6uTK/nPmA/mceYwty7C
# oHkWFelPAx0nx8ASeFlpavrc9+y/tzx2vUDdk/0hINdJ1hw4chvb3uayoYIDTDCC
...
# NjE1MDBaMD8GCSqGSIb3DQEJBDEyBDAUnB/P0gCnMyEdCwiDg4fDst5mzT7XdBd8
# w6ARtR+4NnZdPBySpbINadZFSfikTqkwDQYJKoZIhvcNAQEBBQAEggIAiZfG9fcr
# GEdRRWbClk3ruUhnC9V414F0ratOaF2KHjp3MJjyYOf6QIxY2TQOTUSUAalAKS7J
# CM/RA/ow78ClcWl7tzCb30NnmzZ56AdSIuTlS0n3NT1ZUId5C0oy6yzo8gMjPJ/g
# PUJvebWu/LoCinZYkYUw06Z+T8KElEWUizs4IHu56PtD62QJeFIQdUJkZrOQaY+Q
# eZZf/Q3AUrEYcY1WrNXdi5Q5Ym+HP1dErEQrIqIqjHGSzhP80sNtEGUiCggu0zQa
# qln2f9VThsx/QlJP6n8tUYpajDITH7iGPiC3MYNiHaQrNyRUOYY8OI4j7InRJJrt
# ziu9WPfCikXrzokL0nLclT0BAUDwg8ISMPevmf0CDTI3Z3HJmC88E/+TBN1Sa0IZ
# TrMhnIc3PH3PgLb45p2gihqTCfidUwezD45V8ZwhnCDmXPm8mQKF3mkhcv7wfStU
# OHlCn1YIDAaLF+jS6yt4CVgbqKXYqjen+Fq/OXuh8VhCyfl6ur9+rGfQCTJo3me9
# f8ZwV3ra04YrL+qCu7axKDK3eZQ0bkZ+CnMYhDhV1gE767FmNnMKeBy3UIcKJFnP
# 0Bp8dbusM7ojoOhi4cWSsRHdS76clkQlATvcx3D0RR+KSOWKLpTzJJWDjGHPQ17/
# O2nks62lIOWz7lnpJw908U8IJ2w7HI4tEd8=
